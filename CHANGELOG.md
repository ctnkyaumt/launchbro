...
- fixed profile import not finding the profile folder unless it had an exact expected name.
- completed translations for all 16 supported languages - newer strings (uninstall, import/export, auto-update, migration) had been falling back to English.
