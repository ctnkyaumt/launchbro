...
- completed the Turkish translation: the newer strings (uninstall, export/import profile, scheduled auto-update, app self-update, migration, and related dialogs) were untranslated and showed in English under a Turkish UI - they are now translated. Other languages still fall back to English for those newer strings.
